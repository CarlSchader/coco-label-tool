import { isPolygonInsidePolygon, isPointInPolygon } from '../../static/js/utils/geometry.js';
...
describe('isPointInPolygon', () => {
  ...
  test('handles polygon with many vertices', () => {
    const octagon = [50, 0, 100, 20, 120, 70, 100, 120, 50, 140, 0, 120, -20, 70, 0, 20];
...
describe('isPolygonInsidePolygon', () => {
  ...
  test('respects 80% threshold for containment', () => {
    ...
    expect(isPolygonInsidePolygon(innerSquareWith4Points, outerSquare)).toBe(true);
  });
  ...
  test('returns false when less than 80% of points are inside', () => {
    ...
    expect(isPolygonInsidePolygon(partiallyInsideSquare, outerSquare)).toBe(false);
  });
  ...
  test('handles complex polygon shapes', () => {
    const largeOctagon = [[50, 0, 150, 0, 200, 50, 200, 150, 150, 200, 50, 200, 0, 150, 0, 50]];
