...
describe('getSupercategoryColor', () => {
  ...
  test('returns gray for none supercategory', () => {
    ...
    const color = getSupercategoryColor('none', mockCategories, supercategoryColors);
    expect(color).toEqual([180, 180, 180]);
  });

  test('returns gray for null supercategory', () => {
    const supercategoryColors = {};
    const color = getSupercategoryColor(null, mockCategories, supercategoryColors);
    expect(color).toEqual([180, 180, 180]);
  });

  test('caches supercategory color', () => {
    const supercategoryColors = {};
    const color1 = getSupercategoryColor('animal', mockCategories, supercategoryColors);
    const color2 = getSupercategoryColor('animal', mockCategories, supercategoryColors);
  ...
  test('returns different colors for different supercategories', () => {
    const supercategoryColors = {};
    const color1 = getSupercategoryColor('animal', mockCategories, supercategoryColors);
    const color2 = getSupercategoryColor('vehicle', mockCategories, supercategoryColors);
  ...
  test('returns RGB array with 3 elements', () => {
    const supercategoryColors = {};
    const color = getSupercategoryColor('animal', mockCategories, supercategoryColors);
...
describe('getCategoryColor', () => {
  ...
  test('returns gray for null category', () => {
    ...
    const color = getCategoryColor(null, mockCategories, supercategoryColors, categoryColors);
    expect(color).toEqual([180, 180, 180]);
  });
  ...
  test('caches category color', () => {
    ...
    const color1 = getCategoryColor(category, mockCategories, supercategoryColors, categoryColors);
    const color2 = getCategoryColor(category, mockCategories, supercategoryColors, categoryColors);
  ...
  test('returns base color for single category in supercategory', () => {
    ...
    const color = getCategoryColor(category, singleCategories, supercategoryColors, categoryColors);
    const superColor = getSupercategoryColor('vehicle', singleCategories, supercategoryColors);
  ...
  test('returns RGB array with 3 elements', () => {
    ...
    const color = getCategoryColor(category, mockCategories, supercategoryColors, categoryColors);
