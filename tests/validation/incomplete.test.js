...
describe('checkIncompleteSupercategories', () => {
  ...
  test('returns null when currentImage is null', () => {
    const annotations = {};
    const result = checkIncompleteSupercategories(null, annotations, mockCategories);
  ...
  test('returns null when no annotations exist for image', () => {
    ...
    const annotations = {};
    const result = checkIncompleteSupercategories(currentImage, annotations, mockCategories);
    expect(result).toBeNull();
  });
  ...
  test('handles supercategory with only one category', () => {
    ...
    const result = checkIncompleteSupercategories(currentImage, annotations, singleCatSuper);
  ...
  test('ignores categories with supercategory "none"', () => {
    ...
    const result = checkIncompleteSupercategories(currentImage, annotations, categoriesWithNone);
  ...
  test('ignores categories with null supercategory', () => {
    ...
    const result = checkIncompleteSupercategories(currentImage, annotations, categoriesWithNull);
  ...
  test('ignores categories with empty string supercategory', () => {
    ...
    const result = checkIncompleteSupercategories(currentImage, annotations, categoriesWithEmpty);
