...
export function createWarningListItem(
  title,
  annotatedItems,
  missingItems,
  style = {},
  ...
  titleDiv.style.cssText =
    style.title || "font-weight: bold; color: #48d1cc; margin-bottom: 8px;";
  ...
  if (missingItems && missingItems.length > 0) {
    ...
    missingDiv.style.cssText =
      style.missing || "font-size: 12px; color: #f85149;";
